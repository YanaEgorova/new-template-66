      ...
      <div class="header__wrapper-top">
        <div class="container">
          <div class="headet__top">
            ...
            <div class="headet__top-box">
              <a href="" class="nav__link header-contact__link js_website-email"></a>
              <a href="" class="nav__link header-contact__link js_website-phone"></a>
            </div>
          </div>
        </div>
      </div>
      <div class="container">
        <header class="header">
          ...
          <a href="./shop.html" class="cart__btn">
            <svg fill="#e4e7d2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 424.449 424.449" style="enable-background:new 0 0 424.449 424.449;" xml:space="preserve">
              <g>
                <g>
                  <g>
          ...
          <div class="container">
            ...
            <div class="footer__block footer__block--jus">
              ...
              <ul class="sub-list">
                ...
                <li class="item item--df">
                  <img src="./img/map.png" alt="" class="icon">
